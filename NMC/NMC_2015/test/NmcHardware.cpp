...
NmcHardareRes::NmcHardareRes()
{
	...
	this->pltMotionRange[SPL_X_AXIS] = SPL_X_MOTION_RANGE - SPL_RELATIVE_X_OFFSET - SPL_RANGE_RSV;   //365mm
	this->pltMotionRange[SPL_Y_AXIS] = SPL_Y_MOTION_RANGE - SPL_RELATIVE_Y_OFFSET - SPL_RANGE_RSV;   //365mm
	this->pltMotionRange[SPL_Z_AXIS] = SPL_Z_MOTION_RANGE - SPL_RELATIVE_Z_OFFSET - SPL_RANGE_RSV;   //215 mm
