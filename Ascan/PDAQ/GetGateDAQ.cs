...
namespace Ascan.PDAQ
{
    public class GetGateDAQ
    {
        ...
        public static int Delay(uint ascanNum, GateType type, ref double delay)
        {
            int error_code;
        ...
        public static int Width(uint ascanNum, GateType type, ref double width)
        {
            int error_code;
            int gateNum = (int)type;
        ...
        public static int Threshold(uint ascanNum, GateType type, ref double threshold)
        {
            int error_code;
            int gateNum = (int)type;
            ...
            error_code = DAQ.daqGet((uint)ascanNum, attr, ref val);
            if (error_code != (int)PDAQ_ERR.GOOD)
            {
        ...
        public static int TofMode(uint ascanNum, GateType type, ref TofMode mode)
        {
            int error_code;
            int gateNum = (int)type;
        ...
        public static int DnsActive(uint ascanNum, GateType type, ref DNSActive active)
        {
            int error_code;
            int gateNum = (int)type;
        ...
        public static int DnsBw(uint ascanNum, GateType type, ref double dnsBw)
        {
            int error_code;
            int gateNum = (int)type;
        ...
        public static int DnsStart(uint ascanNum, GateType type, ref double dnsStart)
        {
            int error_code;
            int gateNum = (int)type;
        ...
        public static int DnsStep(uint ascanNum, GateType type, ref double dnsStep)
        {
            int error_code;
            int gateNum = (int)type;
        ...
        public static int AlarmLogic(uint ascanNum, GateType type, ref GateAlarmLogic logic)
        {
            int error_code;
            int gateNum = (int)type;
        ...
        public static int ScActive(uint ascanNum, GateType type, ref SuppressCounterActive active)
        {
            int error_code;
            int gateNum = (int)type;
        ...
        public static int ScCounter(uint ascanNum, GateType type, ref uint cnt)
        {
            int error_code;
            int gateNum = (int)type;
        ...
        public static int DtsActive(uint ascanNum, GateType type, ref DTSActive active)
        {
            int error_code;
            int gateNum = (int)type;
        ...
        public static int DtsBand(uint ascanNum, GateType type, ref double dtsBand)
        {
            int error_code;
            int gateNum = (int)type;
        ...
        public static int DtsStart(uint ascanNum, GateType type, ref double start)
        {
            int error_code;
            int gateNum = (int)type;
        ...
        public static int DtsStep(uint ascanNum, GateType type, ref double step)
        {
            int error_code;
            int gateNum = (int)type;
        ...
        public static int TolMonitorMax(uint ascanNum, GateType type, ref double max)
        {
            int error_code;
            int gateNum = (int)type;
        ...
        public static int TolMonitorMin(uint ascanNum, GateType type, ref double min)
        {
            int error_code;
            int gateNum = (int)type;
            uint attr = DaqAttrType.gate[gateNum].TolMonitorMax;
        ...
        public static int TolMonitorSc(uint ascanNum, GateType type, ref uint cnt)
        {
            int error_code;
            int gateNum = (int)type;
        ...
        public static int AlarmActive(uint ascanNum, GateType type, ref GateAlarmActive active)
        {
            int error_code;
            int gateNum = (int)type;
        ...
        public static int AlarmMode(uint ascanNum, GateType type, ref GateAlarmMode mode)
        {
            int error_code;
            int gateNum = (int)type;
        ...
        public static int AlarmSignalLength(uint ascanNum, GateType type, ref GateAlarmSignalLength len)
        {
            int error_code;
            int gateNum = (int)type;
