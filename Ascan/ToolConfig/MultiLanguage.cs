...
namespace Ascan
{
    ...
    public static class MultiLanguage
    {
        ...
        public static void WriteDefaultLanguage(string lang)
        {
            ...
            ds.ReadXml(AppDomain.CurrentDomain.BaseDirectory.ToString()+"resources/LanguageDefine.xml");
            DataTable dt = ds.Tables["Language"];

            dt.Rows[0]["DefaultLanguage"] = lang;
            ds.AcceptChanges();
            ds.WriteXml(AppDomain.CurrentDomain.BaseDirectory.ToString()+"resources/LanguageDefine.xml");
        }
        ...
        */
        ...
        {
            if (control.Name != "cmbType" && control.Name != "cmbDirection" && control.Name != "cmbReceiver")
                return;
