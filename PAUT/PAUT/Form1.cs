...
namespace PAUT
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            ShowWedgeToGridview();
            GrooveTypePic.Image = PAUT.Properties.Resources.V;
            InspectionSketch.Image = PAUT.Properties.Resources.InspectionSketchV1;
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (GrooveType.SelectedIndex)
            {
                case 0:
                    ...
                    break;
                case 1:
                    GrooveTypePic.Image = PAUT.Properties.Resources.CRC;
                    InspectionSketch.Image = PAUT.Properties.Resources.InspectionSketchCRC1;
                    positionConfig.Visible = true;
                    testBlockPara.Visible = true;
                    pipePara.Visible = false;
                    eleConfig.Visible = false;
                    break;
                case 2:
                    GrooveTypePic.Image = PAUT.Properties.Resources.X;
                    InspectionSketch.Image = PAUT.Properties.Resources.InspectionSketchX;
                    positionConfig.Visible = true;
                    testBlockPara.Visible = true;
                    pipePara.Visible = false;
                    eleConfig.Visible = false;
                ...
                case 3:
                    label1.Text = "检测样管：";
                    GrooveTypePic.Image = PAUT.Properties.Resources.Pipe;
                    InspectionSketch.Image = PAUT.Properties.Resources.InspectionSketchPipe;
        ...
        private void pipeTimeDelayToArray(int centerElement,PointF flawPoint)
        {
            ...
            for (int j = startPointOfSequence; j < startPointOfSequence + EleNum; j++)
            {
                if (j < 32)
                {
                    ...
                    transmit_TD_Temp[numberOfFocus, j] = transmit_TD_Temp[numberOfFocus, j] * 1000 / 0.78125;
                    receive_TD_Temp[numberOfFocus, j] = 16 * receive_TD_Temp[numberOfFocus, j] * 1000 / 10 + 131072;
                }
                else
                {
                    transmit_TD_Temp[numberOfFocus, j-32] = transmit_TD_Temp[numberOfFocus, j-32] * 1000 / 0.78125;
                    receive_TD_Temp[numberOfFocus, j-32] = 16 * receive_TD_Temp[numberOfFocus, j-32] * 1000 / 10 + 131072;
                }
            }
